...
impl SemanticAnalyzer {
    pub fn new() -> Self {
        ...
        if let Some(cmd_map) = Self::load_cmd_map("kubectl") {
            programs.insert("kubectl", Self::program_info_from_cmd_map(cmd_map));
        }

        if let Some(cmd_map) = Self::load_cmd_map("terraform") {
            programs.insert("terraform", Self::program_info_from_cmd_map(cmd_map));
        }

        if let Some(cmd_map) = Self::load_cmd_map("cargo") {
            programs.insert("cargo", Self::program_info_from_cmd_map(cmd_map));
        }

        if let Some(cmd_map) = Self::load_cmd_map("az") {
            programs.insert("az", Self::program_info_from_cmd_map(cmd_map));
        }
